...
>`preprocess_stance out_file_name=pure_lstm_subset.csv`
...
>`preprocess_stance sub_sample=False sentiment=True lexicon=True lstm_wembs=False write_out=False`
...
>`lstm_stance lstm_layers=1 lstm_dimensions=500 max_epochs=500`
